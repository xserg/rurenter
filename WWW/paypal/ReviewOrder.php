		...
		/* The servername and serverport tells PayPal where the buyer
		 ...
		 /* Construct the parameter string that describes the PayPal payment
		   ...
		   */
           ...
           $nvpstr="&AMT=".(string)$L_AMT."&CALLBACKTIMEOUT=4&ReturnUrl=".$returnURL."&CANCELURL=".$cancelURL
               ."&CURRENCYCODE=".$currencyCodeType."&PAYMENTACTION=".$paymentType;
		 ...
		 /* Make the API call and store the results in an array.  If the
		   ...
		   if($ack == 'SUCCESS' || $ack == 'SUCCESSWITHWARNING'){
                    ...
                    header("Location: /office/paypal.php");
                    //header("Location: /office/?op=booking&act=paypal");
			  } else  {
				//Redirecting to APIError.php to display errors.
				$location = "APIError.php";
				header("Location: $location");
