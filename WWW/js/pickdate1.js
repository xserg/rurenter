...
with(document.forms.calendar){
	//alert(document.forms.calendar["ds1[d]"].type);
		if(date1.value == '' && date2.value == ''){
			...
			document.forms.calendar["ds1[Y]"].selectedIndex = parseInt(y1) - 2009;}
			...
			document.forms.calendar["d2[Y]"].selectedIndex = parseInt(y1)- 2009;
			date_OK = true;
		...
		if (date_OK){
				action = aurl+"&start="+ req1.value + "&end=" + req2.value + "&ctype=&rcam=" ;}
		//alert(action);
	}// end of with
